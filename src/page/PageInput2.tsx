      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">
            Sistem Pendaftaran Pelari 2
          </h1>
          <p className="text-gray-600">
            Daftarkan pelari untuk event lari yang akan datang (Versi 2)
          </p>
        </div>
        ...
        {notification && (
          <div
            className={`max-w-md mx-auto mb-6 p-4 rounded-lg ${
        ...
        <div className="max-w-md mx-auto mt-8 p-4 bg-blue-50 rounded-lg">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            ...
            <li>• Ini adalah versi kedua dari sistem pendaftaran</li>
          </ul>
        </div>
      </div>
    </div>
