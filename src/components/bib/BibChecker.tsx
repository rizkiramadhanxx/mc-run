...
const BibCheckerForm: React.FC<BibCheckerFormProps> = ({ onSuccess, onError }) => {
    ...
    <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
      ...
      <div className="mb-4 p-3 bg-gray-50 rounded-lg">
        <div className="flex items-center justify-between">
          <div>
            <label htmlFor="auto-scan" className="text-sm font-medium text-gray-700">
              Auto-scan Mode
            </label>
      ...
      <div className="mt-6 pt-4 border-t border-gray-200">
        ...
        <div className="mt-3 p-2 bg-green-50 rounded text-xs">
          <p className="text-green-700">
            <strong>Scanner Mode:</strong> {isAutoScanEnabled ? 'Auto-submit aktif' : 'Manual mode'}
          </p>
